...
def generate_launch_description():
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            # Clock (Đồng bộ thời gian)
            "/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock",
            # IMU
            "/imu@sensor_msgs/msg/Imu[gz.msgs.IMU",
            # Joint States (Bánh xe quay) - Sửa '/world/empty' nếu tên world của bạn khác
            "/world/empty/model/ttbot/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model"
        ],
        remappings=[
            ('/imu', '/imu/out'),
            ('/world/empty/model/ttbot/joint_state', '/joint_states')
        ]
    )
